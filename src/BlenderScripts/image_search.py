...
def load_image(filename):
	...
	return im
# Find image with searching in directories specified by the "paths" global variable
...
def register():
	...
	register_class(TextureDirectoriesPanel)
	register_class(TEXDIRS_UI_list_slot)
	register_class(TEXDIRS_OT_add_path)
	register_class(TEXDIRS_OT_add_path_with_subpaths)
	register_class(TEXDIRS_OT_move_up)
	register_class(TEXDIRS_OT_move_down)
	register_class(TEXDIRS_OT_remove_path)
	register_class(TEXDIRS_OT_remove_all_paths)
	
def unregister():
	from bpy.utils import unregister_class
	unregister_class(TextureDirectoriesPanel)
	unregister_class(TEXDIRS_UI_list_slot)
	unregister_class(TEXDIRS_OT_add_path)
	unregister_class(TEXDIRS_OT_add_path_with_subpaths)
	unregister_class(TEXDIRS_OT_move_up)
	unregister_class(TEXDIRS_OT_move_down)
	unregister_class(TEXDIRS_OT_remove_path)
	unregister_class(TEXDIRS_OT_remove_all_paths)
